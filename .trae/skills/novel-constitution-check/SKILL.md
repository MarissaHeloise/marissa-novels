---
name: "novel-constitution-check"
description: "$ARGUMENTS Invoke when user wants to use novel.constitution.check command."
---

# Novel Constitution Check
...
3. **Run Check Script**: Execute `.novelkit/scripts/powershell/constitution-manager.ps1 -Action Check -Json "$ARGUMENTS` to:
