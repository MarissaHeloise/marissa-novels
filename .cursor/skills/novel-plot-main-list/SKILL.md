---
name: "novel-plot-main-list"
description: "This command lists all main plots in the novel, providing a comprehensive summary of their status, theme, and key details. Invoke when user wants to use novel.plot.main.list command."
---

# Novel Plot Main List
