---
name: "novel-writer-list"
description: "1. **Run List Script**: Execute `.novelkit/scripts/powershell/writer-manager.ps1 -Action List -Json` to: Invoke when user wants to use novel.writer.list command."
---
...
1. **Run List Script**: Execute `.novelkit/scripts/powershell/writer-manager.ps1 -Action List -Json` to:
